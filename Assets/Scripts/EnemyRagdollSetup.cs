...
public class EnemyRagdollSetup : MonoBehaviour
{
    ...
    public BoneSetup[] boneSetups = new BoneSetup[]
    {
        ...
        new BoneSetup { boneName = "LeftArm", mass = 2f, colliderSize = new Vector3(0.1f, 0.3f, 0.1f) },
        new BoneSetup { boneName = "RightArm", mass = 2f, colliderSize = new Vector3(0.1f, 0.3f, 0.1f) },
        new BoneSetup { boneName = "LeftThigh", mass = 3f, colliderSize = new Vector3(0.15f, 0.4f, 0.15f) },
        new BoneSetup { boneName = "RightThigh", mass = 3f, colliderSize = new Vector3(0.15f, 0.4f, 0.15f) },
        new BoneSetup { boneName = "LeftCalf", mass = 2f, colliderSize = new Vector3(0.1f, 0.3f, 0.1f) },
        new BoneSetup { boneName = "RightCalf", mass = 2f, colliderSize = new Vector3(0.1f, 0.3f, 0.1f) }
    };
